...
\begin{center}
  ...
  $|$
  \faMapMarker \hspace{.5pt} \href{https://maps.app.goo.gl/5JjzZSVMfNeiNpms6}{Prague, Czechia}
\end{center}
...
\section{Work and Research Experience}
  ...
  \small{
    \begin{itemize}
      ...
      \end{itemize}
      \item \textbf{TRECollect} $|$ \href{https://github.com/grp-bork/TRECollect}{\color{blue}\texttt{GitHub}}
      \vspace{-2pt}
      \begin{itemize}
        \item[-] Mobile application for field metadata collection \vspace{-2pt}
      \end{itemize}
    \end{itemize}
  }
